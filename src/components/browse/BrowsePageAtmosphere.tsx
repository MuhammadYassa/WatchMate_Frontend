...
export function BrowsePageAtmosphere({
  ...
  return (
    ...
    >
      <div className="absolute left-[-14%] top-[-4rem] h-[28rem] w-[28rem] rounded-full bg-[radial-gradient(circle,rgba(173,198,255,0.16)_0%,rgba(173,198,255,0)_72%)] blur-3xl" />
      <div className="absolute right-[-12%] top-[20%] h-[24rem] w-[24rem] rounded-full bg-[radial-gradient(circle,rgba(244,211,94,0.12)_0%,rgba(244,211,94,0)_72%)] blur-3xl" />
