...
export function Select({ className, error = false, ...props }: SelectProps) {
  return (
    <select
      className={cn(
        'w-full rounded-2xl border bg-[rgba(12,14,18,0.82)] px-4 py-3.5 text-sm text-[color:var(--color-text-primary)] shadow-[inset_0_1px_0_rgba(255,255,255,0.02)] focus-visible:outline-none',
        error
