...
export function Textarea({ className, error = false, ...props }: TextareaProps) {
  return (
    <textarea
      className={cn(
        'min-h-32 w-full rounded-2xl border bg-[rgba(12,14,18,0.82)] px-4 py-3.5 text-sm text-[color:var(--color-text-primary)] placeholder:text-[color:var(--color-text-tertiary)] shadow-[inset_0_1px_0_rgba(255,255,255,0.02)] focus-visible:outline-none',
        error
