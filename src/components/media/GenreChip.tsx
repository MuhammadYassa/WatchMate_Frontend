  ...
  return (
    <button
      className={cn(
        ...
        active
          ? 'border-[rgba(173,198,255,0.34)] bg-[linear-gradient(145deg,rgba(216,226,255,0.16)_0%,rgba(173,198,255,0.06)_100%)] text-[color:var(--color-accent)] shadow-[0_10px_28px_rgba(173,198,255,0.1)]'
