...
export function SearchPage() {
  ...
  return (
    <PageContainer className="relative isolate space-y-10 overflow-hidden pt-8 md:space-y-12 md:pt-12">
      ...
      <section className="relative z-10 overflow-hidden rounded-[var(--radius-panel)] border border-white/10 bg-[linear-gradient(160deg,rgba(20,21,25,0.9)_0%,rgba(10,11,14,0.98)_100%)] px-5 py-8 shadow-[0_30px_80px_rgba(0,0,0,0.34)] md:px-8 md:py-10 lg:px-10 lg:py-12">
        ...
        <div className="relative space-y-8">
          <div className="space-y-4">
            <h1 className="max-w-4xl font-display text-5xl tracking-[-0.03em] text-white md:text-6xl xl:text-[5.1rem]">
          ...
          <FormField label="Search for a movie or show">
            <div className="relative">
              ...
              />
              <Input
                className="h-16 rounded-[var(--radius-panel)] border-white/10 bg-[rgba(255,255,255,0.04)] pl-14 pr-24 text-base shadow-[inset_0_1px_0_rgba(255,255,255,0.02)] transition duration-300 focus:border-[rgba(47,174,126,0.32)] focus:shadow-[0_0_0_1px_rgba(47,174,126,0.18),0_18px_55px_rgba(0,0,0,0.32)] md:h-20 md:text-lg"
